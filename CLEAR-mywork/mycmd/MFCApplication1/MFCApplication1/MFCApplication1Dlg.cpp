...
void CMFCApplication1Dlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	CString wbuf;
	edit_input.GetWindowTextW(wbuf);
	...
	WriteFile(myhwritepipe, wwbuf, wlength, &realwlength, NULL);
		...
		while (TRUE)
		{
			...
			edit_output.SetSel(-1);
			edit_output.ReplaceSel((CString)rbuf);
